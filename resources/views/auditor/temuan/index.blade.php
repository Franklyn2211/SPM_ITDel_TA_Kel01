  ...
  <div class="page-header-content d-lg-flex">
    <div class="d-flex align-items-center">
      <h3 class="page-title mb-0 fw-bold">
        Daftar FED Disetujui untuk Dibuat Temuan
      </h3>
    </div>
  </div>
      ...
      <table class="table table-hover align-middle mb-0">
        <thead class="table-light">
          <tr>
            ...
            <th style="width:160px;">Status FED</th>
        ...
        <tbody>
          ...
          @forelse($feds as $i => $fed)
            <tr>
              ...
              <td class="text-end">
                <a href="{{ route('auditor.temuan.show', $fed->id) }}"
                   class="btn btn-sm btn-outline-primary">
                  <i class="ph-note-pencil me-1"></i> Buat / Lihat Temuan
                </a>
              </td>
            </tr>
          @empty
